...
BAZEL_COMMAND_LIST="aquery build canonicalize-flags clean config coverage cquery dump fetch help info license mobile-install mod print_action query run shutdown sync test vendor version"
BAZEL_INFO_KEYS="
workspace
install_base
output_base
...
--experimental_downloader_config=path
